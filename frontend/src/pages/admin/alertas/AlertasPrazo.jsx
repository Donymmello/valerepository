    ...
    return (
        <Box>
            ...
            <Typography variant="body2" color="text.secondary" mb={3}>
                Verifique prazos de avaliação e validação que estejam vencidos ou próximos.
            </Typography>
            ...
            <Paper sx={{ p: 3, borderRadius: 3, mb: 3 }}>
                <Stack spacing={2}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                        Esta ação verifica pedidos com prazo de avaliação ou validação próximo
                        do vencimento e gera notificações para acompanhamento no módulo de notificações.
                    </Typography>
                ...
                <Stack spacing={3}>
                    <Paper sx={{ p: 3, borderRadius: 3 }}>
                        ...
                        <Stack spacing={1}>
                            ...
                            <Typography>
                                <strong>Total de alertas criados:</strong> {resultado.totalAlertas || 0}
                            </Typography>
                        </Stack>
                        ...
                        {resultado.alertasCriados?.length ? (
                            <Stack spacing={2}>
                                {resultado.alertasCriados.map((item, index) => (
                                    <Paper key={`${item.pedidoId}-${index}`} variant="outlined" sx={{ p: 2, borderRadius: 2 }}>
                                        <Stack spacing={1}>
                                            <Stack
